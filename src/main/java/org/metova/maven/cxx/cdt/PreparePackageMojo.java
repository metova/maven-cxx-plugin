 ...
 */
package org.metova.maven.cxx.cdt;
...
import org.metova.maven.cxx.qnx.BarDescriptorService;
import org.metova.maven.cxx.qnx.TargetDirectoryService;
...
public class PreparePackageMojo extends JoJoMojoImpl {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        if ( QccToolChain.matches( configuration ) ) {
            ...
            org.metova.maven.cxx.generic.PreparePackageMojo.prepareTargetFile( barFilePath );
        }
            ...
            org.metova.maven.cxx.generic.PreparePackageMojo.prepareTargetFile( buildFile, buildFile.getName() );
        }
    }
}
